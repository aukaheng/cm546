%% 
%  Assignment 5: Neural Network Learning
%
%  Instructions
%  ------------
% 
...
load('ex5data.mat');  % X -> 5000 x 400 (20 x 20 unrolled)
m = size(X, 1);       % m -> 5000

% Randomly select 100 data points to display
sel = randperm( m );  % random permutation (shuffle): 5000 numbers
sel = sel(1:100);     % select the first 100 shuffled elements
...
% Unroll parameters
nn_params = [Theta1(:) ; Theta2(:)];  % Theta1    -> 25 x 401
                                      % Theta2    -> 10 x 26
                                      % nn_params -> 10,285 x 1
...
%  In this part of the assignment, you will be starting to implement a
%  two layer neural network that classifies digits. You will start by
