...
load('ex4data.mat'); % training data stored in arrays X, y
m = size(X, 1);
...
%  In this part of the assignment, you will reuse your logistic regression
%  code from the last assignment. You task here is to make sure that your
