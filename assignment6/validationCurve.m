...
%       values of lambda. You are given the training set (X, y) and
...
%               The vector lambda_vec contains the different lambda  
%               parameters to use for each calculation of the errors, 
%               i.e, error_train(i), and error_val(i) should give you the
%               errors obtained after training with lambda = lambda_vec(i)
%
